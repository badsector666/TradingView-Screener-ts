 ...
 */
export const MARKET_INFO: Record<string, { name: string; description: string; type: 'asset_class' | 'country' }> = {
  // Asset Classes
  ...
  'america': { name: 'United States', description: 'US stock markets (NYSE, NASDAQ, AMEX)', type: 'country' },
  ...
  'southafrica': { name: 'South Africa', description: 'South African stock markets', type: 'country' },
